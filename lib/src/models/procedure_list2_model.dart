...
//
//     final procedureListModel = procedureListModelFromJson(jsonString);

import 'dart:convert';

List<ProcedureListModel> procedureListModelFromJson(String str) => List<ProcedureListModel>.from(json.decode(str).map((x) => ProcedureListModel.fromJson(x)));

String procedureListModelToJson(List<ProcedureListModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ProcedureListModel {
    ...
    factory ProcedureListModel.fromJson(Map<String, dynamic> json) => ProcedureListModel(
        id: json["id"],
        userId: json["user_id"],
