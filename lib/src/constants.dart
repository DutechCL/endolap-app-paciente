...
String url() => 'https://endolap.dutech.cl/api/v1';
...
ButtonStyle primaryButtonStyle() => ButtonStyle(
      backgroundColor:
          MaterialStateProperty.all<Color>(const Color(0xff007eb9)),
...
ButtonStyle accentButtonStyle() => ButtonStyle(
      backgroundColor:
          MaterialStateProperty.all<Color>(const Color(0xff00d6d6)),
      foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
      padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
...
ButtonStyle outlineButtonStyle() => ButtonStyle(
      ...
      side: MaterialStateProperty.all<BorderSide>(
          const BorderSide(color: Color(0xff00d6d6))),
      padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
          const EdgeInsets.symmetric(horizontal: 30, vertical: 20)),
      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
        RoundedRectangleBorder(
